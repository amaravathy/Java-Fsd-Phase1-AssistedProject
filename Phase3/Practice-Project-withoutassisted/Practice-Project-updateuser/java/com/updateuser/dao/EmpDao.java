...
import com.updateuser.beans.Emp;  
...
public int save(Emp p){  
    String sql="insert into employee1(name,salary,designation) values('"+p.getName()+"',"+p.getSalary()+",'"+p.getDesignation()+"')";  
