...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("Amaravathy");
		assertEquals(testUser.getName(),"Amaravathy");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("amaravathy@gmail.com");
		assertEquals(testUser.getEmail(),"amaravathy@gmail.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("Amaravathy","amaravathy@gmail.com","amar");
		
		User checkUser = new User();
		checkUser.setName("Amaravathy");
		checkUser.setEmail("amaravathy@gmail.com");
		checkUser.setPassword("amar");
